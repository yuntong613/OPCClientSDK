...
#ifndef OPCCLIENT_EXPORTS
#define OPCSDKEXPORT __declspec(dllimport)
#else
#define OPCSDKEXPORT __declspec(dllexport)
#endif
...
//值更新回调声明
typedef void(*OPCValueEventCallBack)(char* groupName, char* strNodeName, VARIANT& vValue, int nQuailty, void* pUser);